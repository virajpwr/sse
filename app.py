...
if genre == 'Statistics':
    ...
    image_data = Image.open(
        r'.\plots\descriptive\dataset.jpg')
    ...
    """)
    image_stats = Image.open(
        r'.\plots\descriptive\skewness.jpg')
    ...
    image_stats = Image.open(
        r'.\plots\descriptive\anova2.jpg')
    st.image(image_stats, width=600, caption='ANOVA')
