...
if genre == 'Statistics':
    ...
    image_data = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\sse\plots\descriptive\dataset.jpg')
    ...
    image_stats = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\sse\plots\descriptive\stats.jpg')
    ...
    """)
    image_stats = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\sse\plots\descriptive\skewness.jpg')
    ...
    image_stats = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\descriptive\ttest.jpg')
    ...
    image_stats = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\sse\plots\descriptive\anova.jpg')
    ...
    image_stats = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\sse\plots\descriptive\anova2.jpg')
    st.image(image_stats, width=600, caption='ANOVA')
...
if genre == 'Trend':
    ...
    image_stats = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\boxplots\boxplot.jpg')
    st.image(image_stats, width=600, caption='Box plots')
    st.markdown('The box plots below show the distribution of Var A and Var B for the years 2010 to 2019 and for the months Jan to Dec.')
    image_stats = Image.open(
        r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\boxplots\boxplot2.jpg')
    st.image(image_stats, width=600, caption='Box plots')
