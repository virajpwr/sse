...
if genre == 'Statistics':
    ...
    st.markdown('Dataset')
    image_data = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\descriptive\dataset.jpg')
    ...
    # insert image
    image_stats = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\descriptive\stats.jpg')
    st.image(image_stats, width=250, caption='Descriptive statistics of Var A and Var B')
    ...
    """)
    image_stats = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\descriptive\skewness.jpg')
    ...
    image_stats = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\descriptive\ttest.jpg')
    ...
    image_stats = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\descriptive\anova.jpg')
    ...
    image_stats = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\descriptive\anova2.jpg')
    st.image(image_stats, width=600, caption='ANOVA')
...
if genre == 'box plots':
    ...
    image_stats = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\boxplots\boxplot.jpg')
    st.image(image_stats, width=600, caption='Box plots')
    st.markdown('The box plots below show the distribution of Var A and Var B for the years 2010 to 2019 and for the months Jan to Dec.')
    image_stats = Image.open(r'C:\Users\viraj\OneDrive\interview and prep ondrive\interviews\sse\plots\boxplots\boxplot2.jpg')
    st.image(image_stats, width=600, caption='Box plots')